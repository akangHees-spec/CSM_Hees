                        ...
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            ...
                            <div class="customers-badge">
                                <div class="customer-avatars">
                                    <img src="{{ asset('csm/assets/img/avatar-1.webp') }}" alt="Customer 1" class="avatar">
                                    <img src="{{ asset('csm/assets/img/avatar-2.webp') }}" alt="Customer 2" class="avatar">
                                    <img src="{{ asset('csm/assets/img/avatar-3.webp') }}" alt="Customer 3" class="avatar">
                                    <img src="{{ asset('csm/assets/img/avatar-4.webp') }}" alt="Customer 4" class="avatar">
                                    <img src="{{ asset('csm/assets/img/avatar-5.webp') }}" alt="Customer 5" class="avatar">
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-5">
                                    <div class="profile d-flex align-items-center gap-3">
                                        <img src="{{ asset('csm/assets/img/avatar-1.webp') }}" alt="CEO Profile"
                                            class="profile-image">
                                        <div>
                    ...
                    <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="image-wrapper">
                            <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                                <img src="{{ asset('csm/assets/img/about-5.webp') }}" alt="Business Meeting"
                                    class="img-fluid main-image rounded-4">
                                <img src="{{ asset('csm/assets/img/about-2.webp') }}" alt="Team Discussion"
